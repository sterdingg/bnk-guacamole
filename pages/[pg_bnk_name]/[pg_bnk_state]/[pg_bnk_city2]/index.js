...
function index() {
    ...
    if(count==1){
        ...
        if(item.CITY2===routerdata.query.pg_bnk_city2.replaceAll("_", " ")){
            for_state_set.push(item.BRANCH)
        }
    })
    ...
    return (
        <>
        <HeadSeo headtype="Bank_City_Page" router_data={routerdata?.query}/>
            <form className="container pt-3">
                ...
                <p>City  : {routerdata?.query?.pg_bnk_city2!==undefined?routerdata?.query?.pg_bnk_city2.replaceAll("_", " "):""}</p>
                    <div className="form-group col-md-12">
                        <label htmlFor="input_bankname">Select Bank Branch</label>
                        <div>
